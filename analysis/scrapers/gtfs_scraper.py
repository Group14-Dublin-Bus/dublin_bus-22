...
engine.execute("""CREATE TABLE if not exists gtfs(
                    ...
                    #  if "Departure" in x:
                      ...
                      # dep=str(i["Departure"]["Delay"])
                         ...
                         gtfs = gt
                          ...
                          try:
                               print("INSERTING")
                               ins = ("INSERT INTO gtfs(Time_of_db_update,TripId,StartTime,StartDate,RouteId,StopSequence,StopId,Arr_delay,Dep_delay)"
